...
get_creds_from_env_or_pass() {
  setup_env
  GITHUB_CLIENT_ID="${GITHUB_CLIENT_ID:-$(pass "github.com/${AWS_ACCOUNT}/github_client_id")}"
  GITHUB_CLIENT_SECRET="${GITHUB_CLIENT_SECRET:-$(pass "github.com/${AWS_ACCOUNT}/github_client_secret")}"
}
